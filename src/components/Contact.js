...
export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 text-center ">
      <p className="text-gray-500 mb-3 text-xl">CONTACT</p>
      <h2 className="text-3xl font-bold mb-4">Let’s work together</h2>
      <p className="text-gray-400 mb-10 font-bold">Open to freelance projects, internships, full-time roles,<br /> and meaningful collaborations where I can learn, contribute, and build impactful products and share a good environment.</p>
  ...
  <div className="flex flex-col items-center gap-4">
    ...
    <a
      ...
      className="px-6 py-3 rounded-full bg-purple-600 hover:bg-purple-500 transition box-shadow: 0 0 10px 5px #00bfff;"
    >
      Email Me
    </a>
    ...
    <div className="flex gap-4">
      ...
      <a
        href="https://www.linkedin.com/in/arush-vishwakarma-2b4b621b4/"
