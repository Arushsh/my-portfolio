  ...
  return (
     ...
     <section id="about" className="py-16 md:py-24 px-6">
      <div className="max-w-7xl mx-auto reveal" data-delay="120">
        <p className="text-gray-500 mb-3 text-xl reveal" data-delay="120">ABOUT</p>
      <h2 className="text-3xl font-bold mb-14 reveal" data-delay="150">A quick intro</h2>
      <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 reveal" data-delay="180">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 reveal" data-delay="220">
